...
import { getInstanceById, updateInstance } from "../serivces/instanceService";
import { toast } from "react-toastify";

// eslint-disable-next-line react/prop-types
const EditInstance = ({isOpen,onClose,id}) => {
    ...
    const handleAdd = async(e)=>{
       try{ 
        e.preventDefault();
        const response = await updateInstance(id,data);
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
              <div className="bg-white rounded-lg w-full max-w-2xl my-8">
                <div className="flex justify-between items-center p-4 sm:p-6 border-b">
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Edit Instance</h2>
                  <button
                    onClick={onClose}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            onChange={(e)=>setData((prev)=>(e.target.checked?{...prev,participants:[...data.participants,e.target.id]}:{...prev,participants:data.participants.filter(item=>item!==e.target.id)}))}
                            checked={data.participants.includes('volunteers')}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                            onChange={(e)=>setData((prev)=>(e.target.checked?{...prev,participants:[...data.participants,e.target.id]}:{...prev,participants:data.participants.filter(item=>item!==e.target.id)}))}
                            checked={data.participants.includes('guests')}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                            onChange={(e)=>setData((prev)=>(e.target.checked?{...prev,participants:[...data.participants,e.target.id]}:{...prev,participants:data.participants.filter(item=>item!==e.target.id)}))}
                            checked={data.participants.includes('attendees')}
                          />
                          <label htmlFor="others" className="text-sm text-gray-700">
                            Attendees
                          </label>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            name="tickets"
                            className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                            onChange={(e)=>setData((prev)=>(e.target.checked?{...prev,tickets:[...data.tickets,e.target.id]}:{...prev,tickets:data.tickets.filter(item=>item!==e.target.id)}))}
                            checked={data.tickets.includes('ticket01')}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                            onChange={(e)=>setData((prev)=>(e.target.checked?{...prev,tickets:[...data.tickets,e.target.id]}:{...prev,tickets:data.tickets.filter(item=>item!==e.target.id)}))}
                            checked={data.tickets.includes('ticket02')}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                            onChange={(e)=>setData((prev)=>(e.target.checked?{...prev,tickets:[...data.tickets,e.target.id]}:{...prev,tickets:data.tickets.filter(item=>item!==e.target.id)}))}
                            checked={data.tickets.includes('ticket03')}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                            onChange={(e)=>setData((prev)=>(e.target.checked?{...prev,tickets:[...data.tickets,e.target.id]}:{...prev,tickets:data.tickets.filter(item=>item!==e.target.id)}))}
                            checked={data.tickets.includes('ticket04')}
                          />
                          <label htmlFor="ticket03" className="text-sm text-gray-700">
                            Ticket 04
                          </label>
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                            onChange={(e)=>setData((prev)=>(e.target.checked?{...prev,tickets:[...data.tickets,e.target.id]}:{...prev,tickets:data.tickets.filter(item=>item!==e.target.id)}))}
                            checked={data.tickets.includes('ticket05')}
                          />
                          <label htmlFor="ticket03" className="text-sm text-gray-700">
                            Ticket 05
                          </label>
